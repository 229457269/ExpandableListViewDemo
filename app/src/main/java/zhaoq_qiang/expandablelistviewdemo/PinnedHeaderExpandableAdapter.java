...
public class PinnedHeaderExpandableAdapter extends  BaseExpandableListAdapter implements MyExpandableListView.HeaderAdapter {
	...
	public PinnedHeaderExpandableAdapter(String[][] childrenData,String[] groupData
			,Context context,MyExpandableListView listView){
